...
(defvar +option-id+
  (alexandria:alist-hash-table
   '((#x0000 . :custom)
     ...
     (#x0022 . :set))
   :test #'equal))
(defvar +default-version+ #x04)
(defvar +header-length+ 8)
(defvar +packet-type-index+ 4)
(defvar +request+  #x00)
(defvar +response+ #x01)
...
(defvar +error-codes+
  (alexandria:alist-hash-table
   '((#x0000 . :server-error)
     ...
     (#x1000 . :unavailable-exception)
     (#x1001 . :overloaded)
     (#x1002 . :is-bootstrapping)
     (#x1003 . :truncate-error)
     (#x1100 . :write-timeout)
     (#x1200 . :read-timeout)
     (#x1300 . :read-failure)
     (#x1400 . :function-failure)
     (#x1500 . :write-failure)
     (#x2000 . :syntax-error)
     (#x2100 . :unauthorized)
     (#x2200 . :invalid)
     (#x2300 . :config-error)
     (#x2400 . :already-exists)
     (#x2500 . :unprepared))
   :test #'equal))
